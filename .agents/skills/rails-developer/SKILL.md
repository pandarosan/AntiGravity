...
- **Core:** `.agents/skills/rails/core.md` (Models, Controllers)
- **Testing:** `.agents/skills/rails/testing_rspec.md` or `.agents/skills/rails/testing_minitest.md`
- **Data:** Check if the project uses **Fixtures** (standard) or **FactoryBot**. Respect the existing choice.
- **Frontend:** `.agents/skills/frontend/*` (Hotwire/React/Vue)
