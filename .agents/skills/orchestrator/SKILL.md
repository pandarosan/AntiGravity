...
- **Architecture:** Check if project rules are already populated with stack choices.
...
1.  **Read the Agent File:** Load the content of `.agents/skills/[agent_name]/SKILL.md`.
...
> Action: Read `.agents/skills/rails-architect/SKILL.md`.
